...
class TestRawSourcesConfiguration:
    ...
    def test_receivable_config(self):
        ...
        assert config["spreadsheet_id"] == "1kouZwJy8P_zZhjjn49Lfbp3KN81mhHADV7VKDhv5xkM"
    ...
    def test_payable_config(self):
        ...
        assert config["type"] == "spreadsheet"
        assert config["spreadsheet_id"] == "1b4LWWyfddfiMZWnFreTyC-epo17IR4lcbUnPpLW8X00"
    ...
    def test_cashflow_config(self):
        ...
        assert config["type"] == "spreadsheet"
        assert config["spreadsheet_id"] == "1OZ0cdEob37H8z0lGEI4gCet10ox5DgjO6u4wsQL29Ag"
