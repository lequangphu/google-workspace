# -*- coding: utf-8 -*-
"""
⚠️ DEPRECATED: This script has been migrated to src/modules/import_export_receipts/clean_inventory.py

Use the new module instead:
    from src.modules.import_export_receipts.clean_inventory import process
